    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generate_batch_no', models.CharField(default='', max_length=16)),
        ...
        migrations.AddField(
            model_name='einvoice',
            name='buyer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='as_buyer_own_einvoice_set', to='taiwan_einvoice.legalentity'),
        ),
        migrations.AddField(
            model_name='einvoice',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='as_seller_own_einvoice_set', to='taiwan_einvoice.legalentity'),
        ),
        migrations.AddField(
            model_name='einvoice',
